<div class="panel panel-inverse">
	...
	<div class="panel-heading">
		...
		<h4 class="panel-title">Listado de plantas disponibles</h4>
	</div>
	<!-- end panel-heading -->
	<!-- begin panel-body -->
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="data-table-default_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
						...
						<tbody>
						<?php foreach ($planta as $key => $p) : ?>
                            <tr class="gradeX odd" role="row">
								<td class="f-s-600 text-inverse sorting_1" tabindex="0" width="10%"><?php echo $p->id ?></td>
								<td><?php echo $p->nombre ?></td>
								<td width="120px">
									<button type="button" class="btn btn-primary btn-icon btn-sm" onclick="update('<?=base64_encode($p->id)?>', '<?=$p->nombre?>')" title="Actualizar"><i class="fas fa-pencil-alt fa-fw"></i></button>
