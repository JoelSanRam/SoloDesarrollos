<div class="panel panel-inverse">
	...
	<div class="panel-heading">
		...
		<h4 class="panel-title">Gestión de desarrollos</h4>
	</div>
	<!-- end panel-heading -->
	<!-- begin panel-body -->
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="data-table-default_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
							...
							<div class="col-sm-12"> 
								<table id="data-table-default" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="data-table-default_info">
									<thead>
										...
										<th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1" colspan="1" style="width: 154px;" aria-label="Rendering engine: activate to sort column ascending">Tipo de fraccionamiento</th>
										<th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1" colspan="1" style="width: 215px;" aria-label="Browser: activate to sort column ascending">Unidades</th>
										<th class="text-nowrap sorting" tabindex="0" aria-controls="data-table-default" rowspan="1" colspan="1" style="width: 190px;" aria-label="Platform(s): activate to sort column ascending">Dirección</th>
						...
						<tbody>
						<?php foreach ($desarrollo as $key => $p) : ?>
                            <tr class="gradeX odd" role="row">
								...
								<td><?=($p->privado == 1) ? 'Privado': 'Público';?></td>
								<td><?php echo $p->unidades ?></td>
								<td><?=$p->direccion?></td>
								<td>
									<button type="button" class="btn btn-grey btn-icon btn-sm" onclick="update('<?=base64_encode($p->id)?>')" title="Editar"><i class="fas fa-pencil-alt fa-fw"></i></button>
