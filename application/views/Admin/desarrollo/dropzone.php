    ...
    <div class="col-lg-12 ui-sortable">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-heading ui-sortable-handle">
                ...
                <h4 class="panel-title">Galeria de desarrollo</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
...
<div class="container-fluid" id="list"></div>
    ...
    <script>
        ...
        $("#list").load('<?=base_url()?>desarrollo/dropzone/galeria', { 'key' : '<?=$key?>' });
		...
		function eliminar(key){
			...
			$.ajax({
                ...
                url : '<?=base_url()?>desarrollo/dropzone/eliminar',
        ...
        // event listeners
            var myDropzone = $("#dropzone").dropzone({
                maxFiles: 2000,
                url: "<?=base_url()?>desarrollo/dropzone/upload",
