<div class="panel panel-inverse">
	...
	<div class="panel-heading">
		...
		<h4 class="panel-title">Gestión de empresas</h4>
	</div>
	<!-- end panel-heading -->
	<!-- begin panel-body -->
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="data-table-default_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
						...
						<tbody>
						<?php foreach ($empresa as $key => $p) : ?>
                            <tr class="gradeX odd" role="row">
								<td class="f-s-600 text-inverse sorting_1" tabindex="0" width="1%"><?php echo $p->Id_empresa ?></td>
								...
								<td>
									<a href="<?=base_url()?>empresa/modificar/<?=$p->Id_empresa?>" class="btn btn-grey btn-icon btn-sm"> <i class="fas fa-pencil-alt fa-fw"></i></a>
                                <!-- <button type="button" class="btn btn-grey btn-icon btn-sm"  title="Editar"></button> -->
                                
                                <button type="button" class="btn btn-danger btn-icon btn-sm" onclick="confirmarEliminar(<?=$p->Id_empresa?>)" title="Eliminar"><i class="fas fa-trash-alt fa-fw"></i></button>
                            </td> 
							</tr>
							<?php endforeach; ?>  
							</tbody>
