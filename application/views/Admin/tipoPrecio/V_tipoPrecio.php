...
<div class="content" id="content">
	<div class="row">
		<div class="col-md-3">
			<h2>Tipo de precios</h2>
		</div>
		<div class="col-md-9">
			<a class="btn btn-success col-md-3" type="button" href="#modal-dialog" style="float: right;" data-toggle="modal" data-target="#modal-dialog"><i class="fas fa-lg fa-fw m-r-10 fa-plus-circle"></i>Nuevo tipo de precio</a>
		</div>
	</div>
	...
	<script>
		...
		function insertarForma(){
                $.ajax({
                    type: "POST",
                    url: '<?=base_url()?>Admin/C_tipoPrecio/insertarFormaPago',
			...
			function updateForma(){
                $.ajax({
                    type: "POST",
                    url: '<?=base_url()?>Admin/C_tipoPrecio/ActualizarForma',
