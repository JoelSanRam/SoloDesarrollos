    ...
    <div class="col-lg-12 ui-sortable">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-heading ui-sortable-handle">
                ...
                <h4 class="panel-title">Registro de desarrolladoras</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
            <div class="panel-body">
                <form class="form-horizontal" onsubmit="dataEntry(this, event);" data-parsley-validate="true" name="form-captura" id="form-captura" novalidate="" enctype="multipart/form-data">
                    ...
                    <?=isset($desarrolladora) ? '<input type="hidden" name="key" id="key"value="'.$key.'">' : '' ?>
                    <div class="form-group row m-b-15">
                        <label class="col-md-4 col-sm-4 col-form-label" for="fullname">Nombre * :</label>
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Requerido" data-parsley-required="true"value="<?=isset($desarrolladora) ? $desarrolladora->Nombre : '' ?>">
                        </div>
                    </div>
                    <div class="form-group row m-b-15">
                        <label class="col-md-4 col-sm-4 col-form-label" for="email">Correo * :</label>
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control" type="text" id="email" name="email" data-parsley-type="email" placeholder="Email" data-parsley-required="true" value="<?=isset($desarrolladora) ? $desarrolladora->Correo : '' ?>">
                        </div>
                    </div>
                    <div class="form-group row m-b-15">
                        <label class="col-md-4 col-sm-4 col-form-label" for="message">Teléfono :</label>
                        <div class="col-md-8 col-sm-8">
                            <input class="form-control" type="text" id="telefono" name="telefono" data-parsley-type="number" placeholder="Número de teléfono" data-parsley-required="true" value="<?=isset($desarrolladora) ? $desarrolladora->Telefono : '' ?>">
                        </div>
                    </div>
                    <div class="form-group row m-b-15">
                    ...
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <img id="preview" alt="your image" width="100" height="100" src="<?=base_url()?>recursos/logos/<?=isset($desarrolladora) ? $desarrolladora->Logo : '' ?>" />
                        </div>
                    </div>
            ...
            if( $(form).parsley().validate() ){
                ...
                //formData.append('logo', file);
                 ...
                 $.ajax({
                    ...
                    url : '<?=base_url()?>desarrolladora/guardar',
                    ...
                    success : function(data) {
                        ...
                        if(data > 0){
                            swal({
                                icon: 'success',
                                title: 'Exito',
    	                        text: 'El registro se ha <?=isset($desarrolladora) ? 'actualizado': 'guardado'?> exitosamente',
                                button: false,
                                timer: 1500
                            })
                            <?=isset($desarrolladora) ? '': '
                            $(form).trigger("reset");
