<div class="panel panel-inverse">
	...
	<div class="panel-heading">
		...
		<h4 class="panel-title">Gestión de equipamiento</h4>
	</div>
	<!-- end panel-heading -->
	<!-- begin panel-body -->
					...
					<div id="data-table-default_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
						...
						<?php foreach ($formaPago as $key => $p) : ?>
                            <tr class="gradeX odd" role="row">
								...
								<td class="with-img" width="1%" name="forma<?=$p->equipamiento?>" id="forma<?=$p->id ?>"><?=$p->equipamiento ?></td>
								<td id="forma<?=$p->equipamiento?>">
