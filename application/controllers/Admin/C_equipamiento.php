...
class C_equipamiento extends CI_Controller {
	public function __construct()
    {
        ...
        $this->load->model('Admin/M_equipamiento','mt');
    ...
    {
        $this->load->view('Admin/equipamiento/V_equipamiento');
    }
    public function tabla()
    {
        $vdata["formaPago"] = $this->mt->findall();
        $this->load->view('Admin/equipamiento/tabla', $vdata);
    }
    
    public function guardarformaPago()
    {
        //$vdata["formaPago"] = $this->me->findall();
        $this->load->view('Admin/equipamiento/crea_formaPago');
    }
    ...
    public function insertarFormaPago()
    {
        ...
        //echo "POST";
        $data["equipamiento"] = $this->input->post("formaPago");
        $data["activo"] = 1;
    ...
    public function ActualizarForma(){
        ...
        $data["equipamiento"] =  $this->input->post("formaPago1");
        //var_dump($data);
