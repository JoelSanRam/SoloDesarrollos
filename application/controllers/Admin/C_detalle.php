...
class C_detalle extends CI_Controller {
	public function __construct()
    {
        ...
        $this->load->model('Admin/M_detalle','mt');
    ...
    {
        $this->load->view('Admin/detalle/V_detalle');
    }
    public function tabla()
    {
        $vdata["formaPago"] = $this->mt->findall();
        $this->load->view('Admin/detalle/tabla', $vdata);
    }
    
    public function guardarformaPago()
    {
        //$vdata["formaPago"] = $this->me->findall();
        $this->load->view('Admin/detalle/crea_formaPago');
    }
    ...
    public function insertarFormaPago()
    {
        ...
        //echo "POST";
        $data["detalle"] = $this->input->post("formaPago");
        $data["activo"] = 1;
    ...
    public function ActualizarForma(){
        ...
        $data["detalle"] =  $this->input->post("formaPago1");
        //var_dump($data);
