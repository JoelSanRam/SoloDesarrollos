...
class C_tipoPrecio extends CI_Controller {
	public function __construct()
    {
        ...
        $this->load->model('Admin/M_tipoPrecio','mt');
    ...
    {
        $this->load->view('Admin/tipoPrecio/V_tipoPrecio');
    }
    public function tabla()
    {
        $vdata["formaPago"] = $this->mt->findall();
        $this->load->view('Admin/tipoPrecio/tabla', $vdata);
    }
    
    public function guardarformaPago()
    {
        //$vdata["formaPago"] = $this->me->findall();
        $this->load->view('Admin/tipoPrecio/crea_formaPago');
    }
